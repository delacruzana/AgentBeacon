// src/lib.rs
/*
 * Core library for AgentBeaconNet
 */
...
#[derive(Debug)]
pub struct AgentBeaconNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AgentBeaconNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AgentBeaconNet processing");
    
    let mut processor = AgentBeaconNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AgentBeaconNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AgentBeaconNetProcessor::new(false);
